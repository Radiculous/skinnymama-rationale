(function (a, b) {
    ...
    function f(c, d, e) {
        c.find("ul >li").each(function (f) {
            if (f == e) {
                var g = a(this);
                g.find(".creative_layer").wrap('<div class="layer_container" style="position:absolute;left:0px;top:0px;width:' + d.width + "px;height:" + d.height + 'px"></div>');
        ...
        kenburn: function (d) {
            ...
            return this.each(function () {
                ...
                if (k) a(window).resize(function () {
                    ...
                    h = a("body").find(".responsiveholder").find("div:first");
